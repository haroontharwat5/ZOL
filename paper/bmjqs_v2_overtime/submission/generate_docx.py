...
add_paragraph('Unplanned urgent-case disruption of the elective programme occurred on 858 of 1,247 observation days (68.8%, Table 2B). On days with disruption, elective cases started approximately 30 minutes later than on days without, a gap that reached 60 minutes in early 2022 before narrowing. OR11 absorbed the highest disruption burden, with 475 events affecting 15.2% of its elective cases (Table 2B; Supplementary Table S2).', space_after=6)
