...
# TITLE PAGE
# ============================================================
title_text = 'Where does operating-room overtime come from? A 79,352-case retrospective analysis'
p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.LEFT
pf = p.paragraph_format
...
intro_paras = [
    ...
    'On the patient side, after-hours surgery carries elevated mortality. A meta-analysis reported an adjusted odds ratio of 1.16 (95% CI 1.06 to 1.28), based on low-certainty evidence.[7] A propensity-matched cohort of 281,717 South Korean patients reported a larger effect (odds ratio 3.58), although that estimate has been challenged on residual-confounding grounds.[8,9] Each intraoperative anaesthesia handover raises the odds of a major composite complication, with incidence rising from 8.8% at zero transitions to 21.2% at four or more.[10] A 2025 UK national patient-safety investigation reported that 22% of surveyed doctors experienced daily sleep deprivation and 35% said tiredness had impaired their ability to treat patients.[11] Overtime above a breakpoint threshold has been associated with a 2.09% increase in pressure ulcers across 70 US hospitals.[12] In a multicentre cohort of more than 350,000 non-cardiac surgical cases, night surgery was associated with increased morbidity (adjusted odds ratio 1.41), mediated partly by higher transfusion rates and provider handovers during the case.[13]',
...
add_paragraph('Each case was assigned to a shift based on its actual room-in time: day (08:00 to 16:30), evening (16:30 to 22:00), or night (22:00 to 08:00). A case was flagged as overtime if its room-out fell after the end of its assigned shift. Overtime minutes equal the positive difference between room-out and shift end. We chose this shift-based definition because the staffing change at each boundary is the operational event that makes overtime consequential at this site. The definition aligns with the framework in Bauer et al.[18]', space_after=6)
add_paragraph('An urgent case was deemed to overlap with an elective case when the urgent case\'s actual room matched the elective case\'s planned room and their time intervals (actual for urgent, planned for elective) overlapped.', space_after=6)
...
add_paragraph('All analyses are descriptive; we did not fit causal or inferential models. For RQ1 (distribution), we computed overtime rate, mean, median, and 95th percentile, stratified by room, weekday, year, and shift. For RQ2 (contributing factors), we assessed duration deviation by planned-duration bucket using coefficients of variation,[20,21] shift displacement (cases performed in a different shift than planned), urgency mix and timing, urgent-elective overlap per day and per room, first-case start-time deviation per room, inter-case idle time, and room swaps. This study is reported following the STROBE guidelines for observational studies.', space_after=6)
...
add_paragraph('*Factors not associated with overtime.* Room swaps affected 0.7% of cases (519 of 79,352). Swapped cases had a higher overtime rate (14.8% versus 9.7%), but whether swaps contribute to or result from overtime cannot be determined. Inter-case idle time had a median of 8 minutes and a mean of 9.9 minutes, with a 95th percentile of 25 minutes; turnover was not the bottleneck.[22]', space_after=6)

add_paragraph('First-case punctuality showed no consistent association with room-level overtime. OR10 had the best punctuality (46.1% late) yet the worst overtime (32.9%). OR14 had the second-worst punctuality (78.7% late) yet the lowest overtime (3.5%). OR11 had the worst punctuality (82.4% late) yet mid-pack overtime (11.7%). This is consistent with Pandit et al., who reported R-squared values of 0.04 to 0.08 between start and finish times across more than 7,000 theatre lists.[23]', space_after=6)
...
add_paragraph('The conventional view holds that first-case punctuality drives end-of-day performance, with each minute of tardiness carrying a marginal cost.[25] Our data provide preliminary indications that this relationship may not hold at the room level. The room with the best start-time punctuality had the worst overtime; a room with among the worst punctuality had the lowest. Pandit et al. reported a similar disconnect.[23] First-case-on-time-start may be a useful discipline marker, but these data suggest it should not be assumed to reduce overtime without supporting evidence from the local context.', space_after=6)

add_heading_lower('Implications')
add_paragraph('The overtime we document exposes both staff and patients to established risks. As reviewed in the Introduction, overtime and long shifts are associated with burnout, reduced care quality, and intent to leave,[2,3,4,5] and after-hours surgery carries elevated mortality risk, although the effect size is contested.[7,8,9] At a hospital where 25 rooms drop to 8, then 4, then 1, each case past the shift boundary lands in a setting with fewer staff and more handovers. Room-level monitoring is the necessary first step; Phase 2 of this programme will test whether the overtime patterns we describe are linked to patient outcomes in this cohort.', space_after=6)
