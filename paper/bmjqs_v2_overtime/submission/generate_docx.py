...
add_paragraph('Most overtime cases ended shortly after the shift boundary. The majority of completions fell in the 16:30 to 17:30 window, right after the day-shift handover when most of the rooms had already closed. The distribution decayed through the evening, with a thin tail past 22:00.', space_after=6)
