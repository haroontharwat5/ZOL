# New Literature — Overtime Harm to Staff and Patients

Sources located through targeted search. Verification status: [V] = confident the reference exists with the approximate bibliographic details shown, based on repeated citation in peer-reviewed literature; [?] = reference exists but volume/pages/year should be double-checked on PubMed before submission. All references below must be re-confirmed against PubMed before the final submission regardless of flag. Do not cite [?] items without verification.

Organised by the role each reference plays in the Genk overtime argument.
...
**[V] Turrentine FE, Wang H, Young JS, Calland JF. (2010).** What is the safety of nonemergent operative procedures performed at night? *J Trauma* 69(2):313–19.
**Role:** Non-emergent cases started after 17:00 have increased complications. Directly relevant to cases being cascaded into the evening shift.
...
**[V] Barger LK, Ayas NT, Cade BE, et al. (2006).** Impact of extended-duration shifts on medical errors, adverse events, and attentional failures. *PLoS Med* 3(12):e487.
**Role:** Shifts exceeding 24 hours produced 36 % more serious errors. Closest in design to the long-tail overtime distribution we see in GO10.

**[V] Gates M, Wingert A, Featherstone R, et al. (2018).** Impact of fatigue and insufficient sleep on physician and patient outcomes: a systematic review. *BMJ Open* 8(9):e021967.
**Role:** Consolidated BMJ-stable systematic review. Appropriate for a BMJ QS audience that wants one synthesis-level citation.
...
**[V] Segall N, Bonifacio AS, Schroeder RA, et al. (2012).** Can we make postoperative patient handovers safer? A systematic review. *Anesth Analg* 115(1):102–15.
**Role:** Documents failure rates in OR-to-ICU and OR-to-PACU transitions. Supports the claim that cases crossing shift boundaries land in more and riskier handovers.

**[V] Nagpal K, Arora S, Abboudi M, et al. (2010).** Postoperative handover: problems, pitfalls, and prevention of error. *Ann Surg* 252(1):171–76.
**Role:** Information-loss characterisation at surgical handovers. Already in prior drafts.

### A4. OR flow disruptions — BMJ QS precedent

**[V] Joseph A, Khoshkenar A, Taaffe KM, et al. (2019).** Minor flow disruptions, traffic-related factors and their effect on major flow disruptions in the operating room. *BMJ Qual Saf* 28(4):276–83.
**Role:** Published in BMJ Q&S. Minor disruptions escalate. Parallels our cascading finding — upstream small delays compound into shift displacement.

**[V] Wahr JA, Prager RL, Abernathy JH, et al. (2013).** Patient safety in the cardiac operating room: human factors and teamwork. A scientific statement from the AHA. *Circulation* 128(10):1139–69.
**Role:** Authoritative institutional statement linking team fatigue and late-running cases to patient harm. Useful for the opening framing.

---

## Staff-harm side

### B1. Overtime, burnout, and turnover in nursing
...
**[V] Dall'Ora C, Ball J, Reinius M, Griffiths P. (2020).** Burnout in nursing: a theoretical review. *Hum Resour Health* 18:41.
**Role:** Mechanism paper. Unpredictable workload is a stronger burnout driver than predictable long hours.

**[V] Caruso CC. (2014).** Negative Impacts of Shiftwork and Long Work Hours. *Rehabil Nurs* 39(1):16–25.
**Role:** NIOSH-linked synthesis. Fatigue-to-error chain from a US occupational-health stance.

### B2. Physician and surgeon burnout

**[V] Shanafelt TD, West CP, Sinsky C, et al. (2019).** Changes in Burnout and Satisfaction With Work-Life Integration in Physicians and the General US Population Between 2011 and 2017. *Mayo Clin Proc* 94(9):1681–94.
**Role:** Large-scale longitudinal physician burnout data. Useful for positioning Belgian OR staff within the broader workforce trend.

**[V] Dimou FM, Eckelbarger D, Riall TS. (2016).** Surgeon Burnout: A Systematic Review. *J Am Coll Surg* 222(6):1230–9.
**Role:** Systematic review. Long hours and loss of schedule control are leading drivers — both features of concentrated-room overtime patterns like GO10.

**[V] Sinsky CA, Brown RL, Stillman MJ, Linzer M. (2021).** COVID-Related Stress and Work Intentions in a Sample of US Health Care Workers. *Mayo Clin Proc Innov Qual Outcomes* 5(6):1165–73.
**Role:** Intention-to-leave tied to workload and unpredictable hours. Useful for the "turnover is the cost" framing.

**[V] Van Bogaert P, Peremans L, Van Heusden D, et al. (2017).** Predictors of burnout, work engagement and nurse reported job outcomes and quality of care. *BMC Nurs* 16:5.
**Role:** Flemish nurse workforce study. Directly regional. Workload and schedule control dominate burnout predictors.

### B3. Second-victim and moral distress

**[V] Scott SD, Hirschinger LE, Cox KR, et al. (2009).** The natural history of recovery for the healthcare provider "second victim" after adverse patient events. *Qual Saf Health Care* 18(5):325–30.
**Role:** Second-victim framework. Relevant when late-running cases produce adverse events — the staff affected live with the consequences.
...
## References to add from prior drafts that fit here

- Pandit JJ, et al. (2012), Anaesthesia — first-case punctuality does not predict end-time performance
- Dexter F, Epstein RH (2009), Anesth Analg — the FCOTS cost claim we rebut
- Fügener A, et al. (2017), HCMS — behavioural compression at boundaries
- Wachtel RE, Dexter F (2009), Anesth Analg — cascading through the day
- Joseph A, et al. (2019), BMJ Qual Saf — flow disruption escalation
- Abdelfattah E, et al. (2020), BMJ Qual Saf — workflow disruptions and outcomes (the BMJ QS template)

These span both the operational and the safety layers of the argument.

---

## Total reference footprint

Expected final count for the overtime paper: 22–28 references. Of these, roughly 11 come from the prior verified set (operational core + BMJ Q&S precedents), and the remaining 11–17 come from this new-literature list (patient-harm and staff-harm layers). Vancouver numbered superscript style, per BMJ QS format.
