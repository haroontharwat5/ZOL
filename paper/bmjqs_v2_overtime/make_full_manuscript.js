...
const children = [
  ...
  para([
    ...
    t('Across the 18 rooms, inter-case idle time, a quantity akin to turnover time,'), s('15'),
  ...
  para([
    ...
    t(' Delays have also been shown to build up over an operating list as the scheduled time before each case grows.'), s('17'),
